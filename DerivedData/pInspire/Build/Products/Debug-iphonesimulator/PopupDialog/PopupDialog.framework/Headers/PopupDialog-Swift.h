...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PopupDialog",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (nonnull instancetype)initWithTitle:(NSString * _Nullable)title message:(NSString * _Nullable)message image:(UIImage * _Nullable)image buttonAlignment:(UILayoutConstraintAxis)buttonAlignment transitionStyle:(enum PopupDialogTransitionStyle)transitionStyle preferredWidth:(CGFloat)preferredWidth gestureDismissal:(BOOL)gestureDismissal hideStatusBar:(BOOL)hideStatusBar completion:(void (^ _Nullable)(void))completion;
- (nonnull instancetype)initWithViewController:(UIViewController * _Nonnull)viewController buttonAlignment:(UILayoutConstraintAxis)buttonAlignment transitionStyle:(enum PopupDialogTransitionStyle)transitionStyle preferredWidth:(CGFloat)preferredWidth gestureDismissal:(BOOL)gestureDismissal hideStatusBar:(BOOL)hideStatusBar completion:(void (^ _Nullable)(void))completion OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic) BOOL liveBlurEnabled;
...
@interface PopupDialogOverlayView (SWIFT_EXTENSION(PopupDialog))
/// Whether the blur view should allow for
